...
export const defaultCategories: Category[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'baseShield', label: '기본 쉴드', type: 'number', min: 0, max: 999999 },
      { key: 'baseSpeed', label: '기본 AP', type: 'number', min: 0, max: 99 },
      { key: 'baseEvasion', label: '회피율(%)', type: 'slider', min: 0, max: 100 },
      { key: 'slotWeapon', label: '무기 슬롯', type: 'number', min: 0, max: 10 },
      { key: 'slotEngine', label: '엔진 슬롯', type: 'number', min: 0, max: 10 },
      { key: 'slotArmor', label: '장갑 슬롯', type: 'number', min: 0, max: 2 },
      { key: 'slotShield', label: '쉴드 슬롯', type: 'number', min: 0, max: 2 },
      { key: 'uniqueAbilityName', label: '고유능력 이름', type: 'text' },
      { key: 'uniqueAbilityDesc', label: '고유능력 설명', type: 'textarea' },
    ],
  },
  {
    key: 'ship',
  ...
  },
  {
    ...
    fields: [
      ...commonTextFields,
      { key: 'buildingType', label: '건물 유형', type: 'enum', options: ['command_center', 'research_lab', 'workshop', 'shipyard', 'outpost'] },
      { key: 'isDefaultBuilt', label: '기본 제공', type: 'boolean' },
      { key: 'upgradeCostsJson', label: '업그레이드 비용 (JSON)', type: 'textarea' },
      { key: 'effectsJson', label: '레벨별 효과 (JSON)', type: 'textarea' },
      { key: 'extraEffectsJson', label: '추가 효과 (JSON)', type: 'textarea' },
    ],
  },
  {
    key: 'research',
...
export const projectStarStarterAssets: Asset[] = [
  ...
  starterAsset('hull_gunship', '건십', 'ship_hull', {
    textKey: 'hull_gunship', tier: 1, commandCost: 1,
    baseHp: 80, baseArmor: 30, baseShield: 30, baseSpeed: 8, baseEvasion: 25,
    slotWeapon: 1, slotEngine: 1, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Rapid Maneuver', uniqueAbilityDesc: '첫 이동 AP 비용 -1',
    lore: '빠르고 기동성이 뛰어난 소형 전투함.',
  }),
  starterAsset('hull_frigate', '프리깃', 'ship_hull', {
    textKey: 'hull_frigate', tier: 2, commandCost: 2,
    baseHp: 120, baseArmor: 50, baseShield: 50, baseSpeed: 7, baseEvasion: 15,
    slotWeapon: 2, slotEngine: 1, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Adaptive Combat', uniqueAbilityDesc: '방어 명령 사용 시 Armor +10%',
    lore: '균형 잡힌 범용 호위함.',
  }),
  starterAsset('hull_destroyer', '디스트로이어', 'ship_hull', {
    textKey: 'hull_destroyer', tier: 3, commandCost: 3,
    baseHp: 160, baseArmor: 70, baseShield: 60, baseSpeed: 6, baseEvasion: 10,
    slotWeapon: 3, slotEngine: 2, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Assault Platform', uniqueAbilityDesc: '첫 공격 AP 비용 -1',
    lore: '화력 중심의 공격형 구축함.',
  }),
  starterAsset('hull_cruiser', '크루저', 'ship_hull', {
    textKey: 'hull_cruiser', tier: 4, commandCost: 5,
    baseHp: 240, baseArmor: 120, baseShield: 100, baseSpeed: 5, baseEvasion: 5,
    slotWeapon: 3, slotEngine: 2, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Fortified Hull', uniqueAbilityDesc: '받는 피해 5% 감소',
    lore: '두터운 장갑을 갖춘 주력 순양함.',
  }),
  starterAsset('hull_battlecruiser', '배틀크루저', 'ship_hull', {
    textKey: 'hull_battlecruiser', tier: 5, commandCost: 7,
    baseHp: 320, baseArmor: 150, baseShield: 150, baseSpeed: 5, baseEvasion: 3,
    slotWeapon: 4, slotEngine: 3, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Command Aura', uniqueAbilityDesc: '인접 아군 명중률 +5%',
    lore: '전장 지휘 능력을 갖춘 대형 전투순양함.',
  }),
  starterAsset('hull_dreadnought', '드레드노트', 'ship_hull', {
    textKey: 'hull_dreadnought', tier: 6, commandCost: 10,
    baseHp: 450, baseArmor: 220, baseShield: 220, baseSpeed: 4, baseEvasion: 0,
    slotWeapon: 5, slotEngine: 4, slotArmor: 1, slotShield: 1,
    uniqueAbilityName: 'Flagship', uniqueAbilityDesc: '아군 전체 사기 +10% / 전투 중 1척 제한',
    lore: '함대 최강의 기함. 전투당 단 1척만 배치 가능.',
  }, 'legendary'),
  ...
  // === Buildings ===
  starterAsset('bld_command_center', 'Command Center', 'building', {
    textKey: 'bld_command_center',
    buildingType: 'command_center',
    isDefaultBuilt: true,
    lore: '함대 최대 보유량을 결정하는 사령부. 시작 시 기본 제공.',
    upgradeCostsJson: '{"2":{"stellar":500,"alloy":100},"3":{"stellar":1000,"alloy":200,"energy_crystal":50},"4":{"stellar":1800,"alloy":350,"nanocarbon":50},"5":{"stellar":3000,"alloy":600,"nanocarbon":120,"quantum_data":50}}',
    effectsJson: '{"1":{"max_fleet":2},"2":{"max_fleet":4},"3":{"max_fleet":6},"4":{"max_fleet":8},"5":{"max_fleet":10}}',
    extraEffectsJson: '',
  }),
  starterAsset('bld_research_lab', 'Research Lab', 'building', {
    textKey: 'bld_research_lab',
    buildingType: 'research_lab',
    isDefaultBuilt: true,
    lore: '연구를 해금하는 시설. 시작 시 기본 제공.',
    upgradeCostsJson: '{"2":{"stellar":400,"alloy":80},"3":{"stellar":800,"alloy":150,"energy_crystal":40},"4":{"stellar":1500,"alloy":250,"nanocarbon":40,"energy_crystal":80},"5":{"stellar":2500,"alloy":400,"nanocarbon":100,"energy_crystal":150,"quantum_data":50}}',
    effectsJson: '{"1":{"research_tier":1},"2":{"research_tier":2},"3":{"research_tier":3},"4":{"research_tier":4},"5":{"research_tier":5}}',
    extraEffectsJson: '',
  }),
  starterAsset('bld_workshop', 'Workshop', 'building', {
    textKey: 'bld_workshop',
    buildingType: 'workshop',
    isDefaultBuilt: true,
    lore: '무기·장갑·쉴드·엔진·코어 모듈을 제작하는 시설. 시작 시 기본 제공.',
    upgradeCostsJson: '{"2":{"stellar":500,"alloy":80,"energy_crystal":20},"3":{"stellar":1000,"alloy":180,"energy_crystal":60},"4":{"stellar":1800,"alloy":250,"energy_crystal":120,"nanocarbon":50},"5":{"stellar":3000,"alloy":400,"energy_crystal":250,"nanocarbon":120,"quantum_data":50}}',
    effectsJson: '{"1":{"craft_tier":1},"2":{"craft_tier":2},"3":{"craft_tier":3},"4":{"craft_tier":4},"5":{"craft_tier":5}}',
    extraEffectsJson: '',
  }),
  starterAsset('bld_shipyard', 'Shipyard', 'building', {
    textKey: 'bld_shipyard',
    buildingType: 'shipyard',
    isDefaultBuilt: true,
    lore: '함선 건조·수리·장비 장착 및 교체를 담당하는 시설. 시작 시 기본 제공.',
    upgradeCostsJson: '{"2":{"stellar":500,"alloy":120},"3":{"stellar":1000,"alloy":220,"energy_crystal":40},"4":{"stellar":1800,"alloy":400,"nanocarbon":50},"5":{"stellar":3000,"alloy":700,"nanocarbon":150,"quantum_data":50}}',
    effectsJson: '{"1":{"unlock_ships":["hull_gunship","hull_frigate"],"equip_tier":1},"2":{"unlock_ships":["hull_destroyer"],"equip_tier":2},"3":{"unlock_ships":["hull_cruiser"],"equip_tier":3},"4":{"unlock_ships":["hull_battlecruiser"],"equip_tier":4},"5":{"unlock_ships":["hull_dreadnought"],"equip_tier":5}}',
    extraEffectsJson: '',
  }),
  starterAsset('bld_outpost', 'Outpost', 'building', {
    textKey: 'bld_outpost',
    buildingType: 'outpost',
    isDefaultBuilt: false,
    lore: '점령 행성에 건설하는 전진기지. 고유자원 생산 및 함선 수리 지원.',
    upgradeCostsJson: '{"2":{"stellar":300,"alloy":60,"energy_crystal":20,"unique_resource":1},"3":{"stellar":700,"alloy":120,"energy_crystal":50,"nanocarbon":20,"unique_resource":3},"4":{"stellar":1300,"alloy":220,"energy_crystal":100,"nanocarbon":50,"unique_resource":6},"5":{"stellar":2200,"alloy":350,"energy_crystal":180,"nanocarbon":100,"quantum_data":30,"unique_resource":10}}',
    effectsJson: '{"1":{"resource_rate":1},"2":{"resource_rate":2},"3":{"resource_rate":4},"4":{"resource_rate":6},"5":{"resource_rate":10}}',
    extraEffectsJson: '{"1":"간이수리 50%","2":"간이수리 75%","3":"완전수리 가능","4":"해당 행성 계열 연구비 -10%","5":"해당 행성 계열 제작비 -10%"}',
  }),
